...
- Get started to use OpenFeature with Azure App Configuration and LaunchDarkly.
  - [get-started-open-feature](./backend/get-started-open-feature/)
...
- Example of using gotwi library for Twitter API.
  - [gotwi-example](./go/gotwi-example)

## Infra

- Run Terraform test using mock provider.
  - [run-test-using-mock-provider](./infra/terraform/run-test-using-mock-provider/)
- Comparison between Terraform and OpenTofu.
  - [terraform-opentofu](./infra/terraform-opentofu/)
...
- Run Llama3 on Apple Silicon.
  - [llama3-on-apple-silicon](./llm/meta/llama3-on-apple-silicon/)

## Tools

- Organize macOS screenshots into date-based folders automatically.
  - [move-screen-shot](./tools/macos/automator/move-screen-shot/)
